...
const {makeApiCall, spinnerFlag} = useApiService()

useEffect(()=> {
  const displayBooks =()=>{
    makeApiCall(Method.GET, 'books/viewAllbooks').then((response) => {
...
displayBooks()
  ...
  return (
    <>
     {spinnerFlag ?  <Spinner/> : <Card sx={{ maxWidth: 275, boxShadow: 5 }}>
        <ButtonBase
